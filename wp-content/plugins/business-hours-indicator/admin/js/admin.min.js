...
var Core;!function(t){!function(e){var i=function(){function e(e){var i=t.Admin.Helpers.Context.getSlug();this.parent=e,this.form=this.parent.find("#"+i+"-form"),this.settingsKey=t.Admin.Helpers.Context.getSettingsKey(),this.currentTab=this.parent.find(".nav-tab-active").data("tab"),this.sidebars=this.parent.find(".mabel-sidebar"),this.mainSidebar=this.sidebars.filter('[data-sidebar-for="main"]'),this.initTabs(),this.initDependencies(),this.toggleSidebars(),this.initAjax(),this.initEvents()}return e.prototype.initEvents=function(){var e=this,i=window.tb_remove;window.tb_remove=function(){i(),t.Admin.Dispatcher.publish("modal:closed"),e.saveSettings()},t.Admin.Dispatcher.subscribe("settings:save",function(){e.saveSettings()})},e.prototype.initAjax=function(){var t=this;this.form.find('select, input[type="text"], textarea, input[type=checkbox]').not(".skip-save").on("change",function(){t.saveSettings()})},e.prototype.saveSettings=function(){var e=this;this.parent.find(".all-settings-saved").hide(),this.parent.find(".saving-settings").show();var i=this.form.serialize();jQuery.post("options.php",i).done(function(){e.parent.find(".all-settings-saved").show(),e.parent.find(".saving-settings").hide(),t.Admin.Dispatcher.publish("settings:saved",i)})},e.prototype.initDependencies=function(){var t=this;this.parent.find('[name*="'+this.settingsKey+'"]').each(function(e,i){var n=jQuery(i),s=n.data("dependency");if(s){var a=t.parent.find('[name="'+t.settingsKey+"["+s.element_id+']"]');a&&(a.on("change",function(){var t=a.val(),e=!1;if(a.is(":checkbox")){var i=a.is(":checked");t==s.value&&i&&(e=!0)}else t==s.value&&(e=!0);e?n.closest("tr").show():n.closest("tr").hide()}),a.trigger("change"))}})},e.prototype.initTabs=function(){var e=this,i=this.parent.find(".nav-tab-wrapper a"),n=this.parent.find(".tab");i.on("click",function(s){s.preventDefault();var a=jQuery(s.currentTarget),r=a.data("tab");i.removeClass("nav-tab-active"),a.addClass("nav-tab-active"),n.hide(),e.parent.find(".tab-"+r).show(),t.Admin.Dispatcher.publish("tab:changed",r),e.currentTab=r,e.toggleSidebars()})},e.prototype.toggleSidebars=function(){this.sidebars.hide();var t=this.sidebars.filter('[data-sidebar-for="'+this.currentTab+'"]');t.length&&!t.is(":empty")?t.show():this.mainSidebar.show()},e}();e.Main=i}(t.Admin||(t.Admin={}))}(Core||(Core={}));
