...
function webendev_woocommerce_checkout_fields( $fields ) {
	...
	$fields['order']['order_comments']['placeholder'] = 'Please remeber all deliveries take 30 mins from when orderd, if you have any specific time slot or notes please add them here. ';
	return $fields;
}
